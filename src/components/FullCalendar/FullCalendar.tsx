...
import { events } from '~src/variables/general';
...
class FullCalendar extends React.Component {
  ...
  changeEvent = () => {
    const newEvents = this.state.events.map((prop, key) => {
  ...
  render() {
    return (
      <>
        <div className="fullcalendar-component">
          {this.state.alert}
            ...
            <Card className="card-calendar">
              <CardHeader>
                <Row className="align-items-center py-4">
                  <Col lg="6">
                    <h6 className="fullcalendar-title h2 d-inline-block mb-0 mr-1">
