                    ...
                    <tr key={company.id}>
                        {fields.map((field) => {
                            if (field.name === "checkbox") {
                                ...
                                return (
                                    <td key={company[field.name]}>
                                        {company[field.name].trim().split(";").map(phoneItem => (
                                            <small>
                                                <p className={"ellipsized"}
                                                   style={{
                                                       fontSize: "small",
                                                       marginBottom: 0
                                                   }}>{phoneItem.trim()}
                            ...
                            } else if (field.name === "Socials" || field.name === "Website") {
                                return (
                                    <td key={company[field.name]}>
                                        {company[field.name].trim().split(",").map(socialItem => (
                                            <small>
                                                <p className={"ellipsized"}
                                                   style={{
                                                       fontSize: "small",
                                                       marginBottom: 0
                                                   }}><a href={socialItem.trim()}
                                                         target="_blank">{socialItem.trim()}</a>
                                                </p>
                                            </small>
                                        ))}
                                    </td>
