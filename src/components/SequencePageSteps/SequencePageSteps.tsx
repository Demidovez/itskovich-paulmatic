...
import { MdAdd, MdExpandMore, MdMail, MdOutlineNoteAdd } from 'react-icons/md';
import { RiDeleteBin5Line } from 'react-icons/ri';
import { useDispatch } from 'react-redux';
import { Button } from 'reactstrap';

import ModalYouSure from '~src/components/ModalYouSure/ModalYouSure';
import SequencePageStepsItem from '~src/components/SequencePageStepsItem/SequencePageStepsItem';
import TaskEditorModal from '~src/components/TaskEditorModal/TaskEditorModal';
import { saveStepsSequence } from '~src/store/slices/sequenceMasterSlice';
import { updatedSteps } from '~src/store/slices/sequenceMasterSlice';
